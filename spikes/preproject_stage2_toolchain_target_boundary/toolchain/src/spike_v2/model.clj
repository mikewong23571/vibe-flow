...
(def prompt-templates
  {:mgr
   (str
    "You are the mgr agent for preproject_stage2_toolchain_target_boundary.\n"
   ...
   :impl
   (str
    "You are the impl worker for preproject_stage2_toolchain_target_boundary.\n"
   ...
   :review
   (str
    "You are the review worker for preproject_stage2_toolchain_target_boundary.\n"
    "Your working directory is exactly {{worktree_root}}.\n"
   ...
   :refine
   (str
    "You are the refine worker for preproject_stage2_toolchain_target_boundary.\n"
    "Your working directory is exactly {{worktree_root}}.\n"
    "Only inspect and edit files inside that worktree.\n"
    "Task id: {{task_id}}\n"
    "Task goal: {{goal}}\n"
